...
//            long thanhtien = Long.parseLong(monResult.getGia()) * soluong;
    ...
    private void getChiTietMon() {
        ...
        String motacuacuahang = "\n--------------------------------\n" +
                "Để mua sắm tại MINISHOP, Quý khách có thể lựa chọn các phương thức mua hàng phù hợp:\n" +
                "Danh sách cửa hàng MINISTOP: " +
                "\n  - http://minishop.vn/ms\n" +
                "Mua online Grabmart: " +
                "\n  - https://grb.to/MINISHOP\n" +
                "Mua online ShopeeFood: " +
                "\n  - https://shopeefood.vn/thuong-hieu/minishop-hcm\n" +
                "Mua online Baemin: " +
                "\n  - https://baemin.onelink.me/jjXg/minishop\n" +
                "#minishop #minishopvietnam";
        mota_chitiet.setText(monResult.getMota() + motacuacuahang);
